...
module.exports = {
  expo: {
    ...
    ios: {
      ...
      infoPlist: {
        NSCameraUsageDescription:
          "Camera access is used for visual product search.",
        NSPhotoLibraryUsageDescription:
          "Photo library access is used for visual product search.",
      },
    },
    android: {
      adaptiveIcon: {
    ...
    extra: {
      ...
      liquidGlassDefaultEnabled:
        process.env.EXPO_PUBLIC_LIQUID_GLASS_ENABLED !== "false",
      visualSearchProvider:
        process.env.EXPO_PUBLIC_VISUAL_SEARCH_PROVIDER ?? "none",
      eas: {
        projectId: "04f469e1-74c8-4b69-9135-d5631564a3b2",
      },
    },
  },
};
